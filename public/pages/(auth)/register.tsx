...
const RegisterPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Join Athagili - Find Your Perfect Match</title>
        <meta name="description" content="Create your Athagili account and start your journey to find love and meaningful connections." />
      </Head>
      ...
      <div className="min-h-screen flex">
        ...
        >
          ...
          <div 
            ...
            style={{
              backgroundImage: "url('https://images.unsplash.com/photo-1529156069898-49953e39b3ac?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80')"
            }}
          />
          ...
          <div className="relative z-20 flex items-center justify-center p-12">
            <div className="text-center text-white">
              ...
              >
                Create meaningful connections with people who share your values
              </motion.p>
            </div>
          </div>
        ...
        >
          <div className="max-w-md w-full space-y-8 py-12">
            ...
            >
              ...
              <p className="text-gray-400">Create your account and find your perfect match</p>
            </motion.div>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <select
                    ...
                    onChange={handleInputChange}
                    className="appearance-none rounded-lg relative block w-full px-3 py-3 border border-gray-600 text-white bg-gray-800/50 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-pink-500 focus:z-10 transition-all duration-300"
                  >
                ...
                <div>
                  <select
                    ...
                    className="appearance-none rounded-lg relative block w-full px-3 py-3 border border-gray-600 text-white bg-gray-800/50 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-pink-500 focus:z-10 transition-all duration-300"
                  >
                    <option value="" className="bg-gray-800">Age</option>
                    {ageOptions.map(age => (
              ...
              <div className="flex items-center">
                <input
                  ...
                  type="checkbox"
                  required
                  className="h-4 w-4 text-pink-600 focus:ring-pink-500 border-gray-600 rounded bg-gray-800"
                />
